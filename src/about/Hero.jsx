function Hero() {
    return (
        <div className="container" >
            ...
            <div className="row -5 " style={{ margin: '0 auto',fontSize: '10%', fontWeight: 'bold', padding: '10px' }}>
        ...
        style={{ lineHeight: "1.8", fontSize: "1em" }}>
                ...
                <div className="col-6">
                    ...
                    <p>And yet, we are always up to something new every day. Catch up on the latest updates on our <a href="https://zerodha.com/z-connect/">blog</a> or see what the media is saying about us.</p>
                </div>
            </div>
        </div>
     );
